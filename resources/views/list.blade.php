...
<head>
    ...
    <title> Complaint Manegement</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <ul class="cont-det">
                        <li>+87 676 654 44</li>
                        <li>complaint_management.com</li>
                    </ul>
                </div>
...
<div class="page-nav no-margin row">
    <div class="container">
        <div class="row">
            ...
            <ul>
                <div>
                    <p> Click on the product to add a complain</p>
                </div>
...
<div class="service-container container-fluid">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4" onclick="complaintModal({{$product->id}})">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{action([\App\Http\Controllers\ProductController::class,'productStore'])}}" enctype="multipart/form-data">
                    @csrf
...
<div class="modal fade" id="complaintModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="complaintModalLabel">Modal title</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="post" action="{{action([\App\Http\Controllers\PagesController::class,'complaintStore'])}}" enctype="multipart/form-data">
                    @csrf
